...
SECTION .text				; Code section.
	...
	;Introduction block of code
	;Prints out my name and the title of the assignment 
	introduction:
	...
	;Prompt the user for and integer to calculate the nth sequence 
	get_user_data:
		.prompt:
	...
	;Calculate and display the fibonaccis numbers 
	display_fibs:
		mov ebx, 0
		.loop:
			inc ebx
